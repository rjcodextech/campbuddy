  ...
  container.innerHTML = `
    <div class="card">
      ...
      <div style="display:flex;gap:8px">
        <button type="button" class="btn btn--ghost btn--compact" id="dc-export">Export my data</button>
        <button type="button" class="btn btn--ghost btn--compact" id="dc-clear">Clear my data</button>
      </div>
    </div>
  `;
