...
> **Current implementation note:** the attendee app additionally reads as a mobile-app-style centered card frame up through tablet widths, and switches to a genuine desktop "webapp" layout (sidebar nav, wider content column) above 1024px — a deliberate later product decision.
